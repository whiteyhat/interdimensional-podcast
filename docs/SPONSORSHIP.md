...
The public sidebar now supports Get on air ($5), Project spotlight ($25), and Dress the host ($100): the customer's logo printed on a T-shirt and a cap in the brand's colours, worn by Pepe or Chad for ten live minutes. FROGCLENCH purchases cost exactly 70% of those USD prices. USDC is the default asset; SOL and FROGCLENCH require a fresh market price. Future mugs, audience debates, reactions, and scene packages remain outside checkout.
