...
void test('the house brief rotates concrete current subjects, forbids old years, and leaves the plug to its clock', () => {
  ...
  assert.equal(briefs.filter((b) => /pump dot fun/.test(b)).length, 0, 'the plug rides its own clock (lib/house.ts), never a dry-wire brief');
});
